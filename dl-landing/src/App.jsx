...
/**
 * Deadlock Community – Landingpage SPA (Vite + React)
 * --------------------------------------------------------
 * This file matches the version shared in ChatGPT canvas.
 * Tailwind is pulled via CDN for simplicity (see App return).
 */
    ...
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-700/50 via-slate-900 to-black p-8 md:p-14">
      ...
      <div className="relative">
        <div className="flex items-center gap-2 mb-4">
          ...
          <a href="#/settings" className="text-xs underline text-white/70 hover:text-white">⚙️ Einstellungen</a>
        </div>
